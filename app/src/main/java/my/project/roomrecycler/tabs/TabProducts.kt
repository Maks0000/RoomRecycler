...
import my.project.roomrecycler.databinding.FragmentTabProductsBinding
...
class TabProducts : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_tab_products, container, false)
